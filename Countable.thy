...
next 
 ...
 proof(rule ccontr)
              ...
              proof (rule natural_number_object_func_unique[where X=\<Omega>, where f="id \<Omega>"])
                ...
                proof -
                  ...
                  then show ?thesis
                    using calculation by auto
                qed
                show "(IMPLIES \<circ>\<^sub>c
     \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c
      id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
     \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>) \<circ>\<^sub>c
    successor =
    id\<^sub>c \<Omega> \<circ>\<^sub>c
    IMPLIES \<circ>\<^sub>c
    \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c
     id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
    \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>"
                proof(rule one_separator[where X = "\<nat>\<^sub>c", where Y = "\<Omega>"])
                  show "(IMPLIES \<circ>\<^sub>c
     \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c
      id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
    ...
    successor : \<nat>\<^sub>c \<rightarrow> \<Omega>"
                    by typecheck_cfuncs
                  show "id\<^sub>c \<Omega> \<circ>\<^sub>c
    IMPLIES \<circ>\<^sub>c
    \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c
     id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
    \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> : \<nat>\<^sub>c \<rightarrow> \<Omega>"
                    by typecheck_cfuncs
                  show "\<And>q. q \<in>\<^sub>c \<nat>\<^sub>c \<Longrightarrow>
         ((IMPLIES \<circ>\<^sub>c
           \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c
            id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f
            successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
           \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>) \<circ>\<^sub>c
         ...
         q"
          ...
          (successor \<circ>\<^sub>c q)"
           ...
           \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c
            id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f
            successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
           \<langle>id\<^sub>c \<nat>\<^sub>c \<circ>\<^sub>c (successor \<circ>\<^sub>c q) ,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub> \<circ>\<^sub>c (successor \<circ>\<^sub>c q)\<rangle>"
                      by (typecheck_cfuncs, simp add: cfunc_prod_comp)
                    also have "... = IMPLIES \<circ>\<^sub>c
           \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c
            (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)),NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n))\<rangle> \<circ>\<^sub>c
           \<langle>(successor \<circ>\<^sub>c q) ,id one\<rangle>"
                      using beta_N_succ_mEqs_Id1 id_left_unit2 by (typecheck_cfuncs, presburger)
                    also have "... = IMPLIES \<circ>\<^sub>c
           \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c
            (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c
           \<langle>(successor \<circ>\<^sub>c q) ,id one\<rangle>,
NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c
           \<langle>(successor \<circ>\<^sub>c q) ,id one\<rangle>\<rangle> "
                      using cfunc_prod_comp comp_associative2 by (typecheck_cfuncs,force)
                    also have "... = IMPLIES \<circ>\<^sub>c
           \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c
           \<langle>id\<^sub>c \<nat>\<^sub>c \<circ>\<^sub>c (successor \<circ>\<^sub>c q) ,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c id one\<rangle>,
            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>id\<^sub>c \<nat>\<^sub>c \<circ>\<^sub>c (successor \<circ>\<^sub>c q) ,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c id one\<rangle>\<rangle> "
                      using cfunc_cross_prod_comp_cfunc_prod by (typecheck_cfuncs, force)
                    also have "... = IMPLIES \<circ>\<^sub>c
           \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c
           \<langle>(successor \<circ>\<^sub>c q) ,(successor \<circ>\<^sub>c n)\<rangle>,
            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>(successor \<circ>\<^sub>c q) ,(successor \<circ>\<^sub>c n) \<rangle>\<rangle>"
                      using id_left_unit2 id_right_unit2 by (typecheck_cfuncs, force)
                    also have "... = IMPLIES \<circ>\<^sub>c
           \<langle>(NOT \<circ>\<^sub>c eq_pred X) \<circ>\<^sub>c 
           \<langle>i \<circ>\<^sub>c (successor \<circ>\<^sub>c q) ,i \<circ>\<^sub>c (successor \<circ>\<^sub>c n)\<rangle>,
            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>(successor \<circ>\<^sub>c q) ,(successor \<circ>\<^sub>c n) \<rangle>\<rangle>"
                      by (typecheck_cfuncs, smt (z3) cfunc_cross_prod_comp_cfunc_prod comp_associative2)
                    also have "... = IMPLIES \<circ>\<^sub>c
           \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c \<langle>i \<circ>\<^sub>c (successor \<circ>\<^sub>c q) ,i \<circ>\<^sub>c (successor \<circ>\<^sub>c n)\<rangle>,
            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>(successor \<circ>\<^sub>c q) ,(successor \<circ>\<^sub>c n) \<rangle>\<rangle>"
                      using comp_associative2 by (typecheck_cfuncs, force)
                    also have "... = \<t>"
                    ...
                    also have "... =   IMPLIES \<circ>\<^sub>c
                              \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c   \<langle>i  \<circ>\<^sub>c q, i  \<circ>\<^sub>c successor \<circ>\<^sub>c n\<rangle>,
                               NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c  \<langle>q, successor \<circ>\<^sub>c n\<rangle>\<rangle>"
                      by (typecheck_cfuncs, metis IMPLIES_false_is_true_false NOT_is_true_implies_false eq_pred_iff_eq true_false_only_truth_values)
                    also have "... =
                              IMPLIES \<circ>\<^sub>c
                              \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c  \<langle>q, successor \<circ>\<^sub>c n\<rangle>,
                               NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c  \<langle>q, successor \<circ>\<^sub>c n\<rangle>\<rangle>"
                      by (typecheck_cfuncs, simp add: cfunc_cross_prod_comp_cfunc_prod)
                    also have "... = 
                              IMPLIES \<circ>\<^sub>c
                              \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c \<langle>q, id one\<rangle>,
                               NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c \<langle>q, id one\<rangle>\<rangle>"
                      by (typecheck_cfuncs, smt (z3) cfunc_cross_prod_comp_cfunc_prod comp_associative2 id_left_unit2 id_right_unit2)
                    also have "... = 
                    IMPLIES \<circ>\<^sub>c
                              \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c
                               id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f
                               successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
                              \<langle>q, id one\<rangle> "
                      using cfunc_prod_comp comp_associative2 by (typecheck_cfuncs, force)
                    also have "... = IMPLIES \<circ>\<^sub>c
                            \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c
                             id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f
                             successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
                            \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> \<circ>\<^sub>c q"
                      using cart_prod_extract_left id_left_unit2 by (typecheck_cfuncs, force)
                    also have "... = (id\<^sub>c \<Omega> \<circ>\<^sub>c
                          IMPLIES \<circ>\<^sub>c
                          \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c
                           id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f
                           successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
                ...
                qed
                show "(IMPLIES \<circ>\<^sub>c
     \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n\<rangle> \<circ>\<^sub>c
     \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>) \<circ>\<^sub>c
    successor =
    id\<^sub>c \<Omega> \<circ>\<^sub>c
    IMPLIES \<circ>\<^sub>c
    ...
    \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> : \<nat>\<^sub>c \<rightarrow> \<Omega>"
         ...
         q"
           ...
           \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>) \<circ>\<^sub>c
          successor) \<circ>\<^sub>c
         q =IMPLIES \<circ>\<^sub>c
           \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n\<rangle> \<circ>\<^sub>c
           \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> \<circ>\<^sub>c (successor  \<circ>\<^sub>c q)"
                      by (typecheck_cfuncs, smt (z3) comp_associative2)
                    also have "... = IMPLIES \<circ>\<^sub>c
           \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n\<rangle> \<circ>\<^sub>c
           \<langle>successor  \<circ>\<^sub>c q, id one\<rangle>"
                    ...
                    also have "... = IMPLIES \<circ>\<^sub>c
           \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n) \<circ>\<^sub>c \<langle>successor  \<circ>\<^sub>c q, id one\<rangle>,
            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n) \<circ>\<^sub>c \<langle>successor  \<circ>\<^sub>c q, id one\<rangle>\<rangle>"
                      by (typecheck_cfuncs, smt (z3) cfunc_prod_comp comp_associative2)
                    also have "... = IMPLIES \<circ>\<^sub>c
           \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c  \<langle>successor  \<circ>\<^sub>c q, n\<rangle>,
            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c  \<langle>successor  \<circ>\<^sub>c q, n\<rangle>\<rangle>"
                      using cfunc_cross_prod_comp_cfunc_prod id_left_unit2 id_right_unit2 by (typecheck_cfuncs, force)
                    also have "... = IMPLIES \<circ>\<^sub>c
           \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c  \<langle>i \<circ>\<^sub>c successor  \<circ>\<^sub>c q, i \<circ>\<^sub>c n\<rangle>,
            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c  \<langle>successor  \<circ>\<^sub>c q, n\<rangle>\<rangle>"
                      by (typecheck_cfuncs, simp add: cfunc_cross_prod_comp_cfunc_prod)
                    also have "... = \<t>"  
                      by (typecheck_cfuncs, metis IMPLIES_false_is_true_false NOT_false_is_true eq_pred_iff_eq true_false_only_truth_values)
                    also have "... = IMPLIES \<circ>\<^sub>c
          \<langle> NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c   \<langle>i \<circ>\<^sub>c q,i \<circ>\<^sub>c n\<rangle>, 
            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c  \<langle>q, n\<rangle>\<rangle>"
                      by (typecheck_cfuncs, metis IMPLIES_false_is_true_false NOT_false_is_true eq_pred_iff_eq true_false_only_truth_values)
                    also have "... = IMPLIES \<circ>\<^sub>c
                              \<langle> NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c  \<langle>q,n\<rangle>, 
                                NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c  \<langle>q, n\<rangle>\<rangle>"
                      by (typecheck_cfuncs, simp add: cfunc_cross_prod_comp_cfunc_prod)
                    also have "... = IMPLIES \<circ>\<^sub>c
                              \<langle> NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n) \<circ>\<^sub>c \<langle>q,id one\<rangle>, 
                                NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n) \<circ>\<^sub>c \<langle>q,id one\<rangle>\<rangle>"
                      by (typecheck_cfuncs, simp add: cfunc_cross_prod_comp_cfunc_prod id_left_unit2 id_right_unit2)
                    also have "... = IMPLIES \<circ>\<^sub>c
                              \<langle> NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n), NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n)\<rangle> \<circ>\<^sub>c \<langle>q,id one\<rangle>"
                      using cfunc_prod_comp comp_associative2 by (typecheck_cfuncs, force)
                    also have "... = IMPLIES \<circ>\<^sub>c
                            \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n\<rangle> \<circ>\<^sub>c
                            \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>  \<circ>\<^sub>c  q"
              ...
              qed
              show "IMPLIES \<circ>\<^sub>c
    \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,
      NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> =
                    IMPLIES \<circ>\<^sub>c 
    \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n,
      NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n\<rangle>"
              proof - 
                have "IMPLIES \<circ>\<^sub>c
    \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,
      NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> =  
    ...
    \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)),
      NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n))\<rangle>"
            ...
            proof -
              have "IMPLIES \<circ>\<^sub>c
    \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)),
    NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n))\<rangle> \<circ>\<^sub>c \<langle>id \<nat>\<^sub>c, \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> = \<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>"
              proof (rule natural_number_object_func_unique[where X=\<Omega>, where f="id \<Omega>"])
                show "IMPLIES \<circ>\<^sub>c
    \<langle>NOT \<circ>\<^sub>c
     eq_pred X \<circ>\<^sub>c
     (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
    \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> : \<nat>\<^sub>c \<rightarrow> \<Omega>"
                  by typecheck_cfuncs
                show "\<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub> : \<nat>\<^sub>c \<rightarrow> \<Omega>"
                  by typecheck_cfuncs
                ...
                show "(IMPLIES \<circ>\<^sub>c
     \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,
     NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
     \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>) \<circ>\<^sub>c  zero =
          (\<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>) \<circ>\<^sub>c zero"
                proof - 
                  have "(IMPLIES \<circ>\<^sub>c
     \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,
     NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
     \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>) \<circ>\<^sub>c  zero = IMPLIES \<circ>\<^sub>c
     \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)),
     NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n))\<rangle> \<circ>\<^sub>c \<langle>zero, id one\<rangle>"
                    by (typecheck_cfuncs, metis cart_prod_extract_left cfunc_type_def comp_associative id_left_unit2)
                  also have "... = IMPLIES \<circ>\<^sub>c
     \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c \<langle>zero, id one\<rangle>,
     NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c \<langle>zero, id one\<rangle> \<rangle>"
                    using cfunc_prod_comp comp_associative2 by (typecheck_cfuncs, force)
                  also have "... = IMPLIES \<circ>\<^sub>c
     \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c  \<langle>zero, (successor \<circ>\<^sub>c n)\<rangle>,
     NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c            \<circ>\<^sub>c \<langle>zero, (successor \<circ>\<^sub>c n)\<rangle> \<rangle>"
                    using cfunc_cross_prod_comp_cfunc_prod id_left_unit2 id_right_unit2 by (typecheck_cfuncs, force)
                  also have "... = IMPLIES \<circ>\<^sub>c
     \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c            \<langle>i \<circ>\<^sub>c zero, i \<circ>\<^sub>c successor \<circ>\<^sub>c n\<rangle>,
     NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c            \<circ>\<^sub>c \<langle>zero, (successor \<circ>\<^sub>c n)\<rangle> \<rangle>"
                    by (typecheck_cfuncs, simp add: cfunc_cross_prod_comp_cfunc_prod)
                  also have "... = IMPLIES \<circ>\<^sub>c
     \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c            \<langle>x, m \<circ>\<^sub>c i \<circ>\<^sub>c n\<rangle>,
     NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c            \<circ>\<^sub>c \<langle>zero, (successor \<circ>\<^sub>c n)\<rangle> \<rangle>"
                    by (typecheck_cfuncs, metis cfunc_type_def comp_associative i_induct ibase)
                  also have "... = \<t>" 
                    by (typecheck_cfuncs, metis IMPLIES_false_is_true_false NOT_false_is_true eq_pred_iff_eq true_false_only_truth_values zero_is_not_successor)
                  also have "... = (\<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>) \<circ>\<^sub>c zero"
                    using comp_associative2 is_even_def2 is_even_nth_even_true nth_even_def2 zero_type by fastforce
                  then show ?thesis
                    using calculation by presburger
                qed
                show "(IMPLIES \<circ>\<^sub>c
    ...
    \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>"
     ...
     \<langle>NOT \<circ>\<^sub>c
      ...
      (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
     \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>) \<circ>\<^sub>c
    successor = IMPLIES \<circ>\<^sub>c
     \<langle>NOT \<circ>\<^sub>c
      eq_pred X \<circ>\<^sub>c
      (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
     \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> \<circ>\<^sub>c successor"
                    by (typecheck_cfuncs, metis cfunc_type_def comp_associative)
                  also have "... = IMPLIES \<circ>\<^sub>c
     \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,
      NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
     \<langle>successor,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>"
                    using cfunc_prod_comp id_left_unit2 terminal_func_comp by (typecheck_cfuncs, force)
                  also have "... = IMPLIES \<circ>\<^sub>c
     \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c \<langle>successor,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>,
      NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c \<langle>successor,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> \<rangle>"
                    using cfunc_prod_comp comp_associative2 by (typecheck_cfuncs, force)
                   also have "... = IMPLIES \<circ>\<^sub>c
     \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c    \<langle>id\<^sub>c \<nat>\<^sub>c \<circ>\<^sub>c successor,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>,
      NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>id\<^sub>c \<nat>\<^sub>c \<circ>\<^sub>c successor,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> \<rangle>"
                     using cfunc_cross_prod_comp_cfunc_prod by (typecheck_cfuncs, force)                   
                   also have "... = IMPLIES \<circ>\<^sub>c
     \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c    \<langle>successor, (successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>,
      NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>id\<^sub>c \<nat>\<^sub>c \<circ>\<^sub>c successor,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> \<rangle>"
                     using id_left_unit2 by (typecheck_cfuncs, presburger)
                   also have "... = \<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>"
                   proof(rule one_separator[where X = "\<nat>\<^sub>c", where Y = \<Omega>])            
                     show "IMPLIES \<circ>\<^sub>c
    \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c \<langle>successor, (successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>,
     NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>id\<^sub>c \<nat>\<^sub>c \<circ>\<^sub>c successor,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>\<rangle> : \<nat>\<^sub>c \<rightarrow> \<Omega>"
                       by typecheck_cfuncs
                     show "\<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub> : \<nat>\<^sub>c \<rightarrow> \<Omega>"
                       by typecheck_cfuncs
                     show "\<And>q. q \<in>\<^sub>c \<nat>\<^sub>c \<Longrightarrow>
         (IMPLIES \<circ>\<^sub>c \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c(i \<times>\<^sub>f i) \<circ>\<^sub>c \<langle>successor,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>,
                     NOT \<circ>\<^sub>c  eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>id\<^sub>c \<nat>\<^sub>c \<circ>\<^sub>c successor,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>\<rangle>) \<circ>\<^sub>c  q = (\<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>) \<circ>\<^sub>c q"
                     proof - 
                       fix q 
                       assume q_type[type_rule]: "q \<in>\<^sub>c \<nat>\<^sub>c"
                       have "(IMPLIES \<circ>\<^sub>c \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c(i \<times>\<^sub>f i) \<circ>\<^sub>c \<langle>successor,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>,
                     NOT \<circ>\<^sub>c  eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>id\<^sub>c \<nat>\<^sub>c \<circ>\<^sub>c successor,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>\<rangle>) \<circ>\<^sub>c  q = 
                            IMPLIES \<circ>\<^sub>c \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c(i \<times>\<^sub>f i) \<circ>\<^sub>c \<langle>successor,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>,
                                               NOT \<circ>\<^sub>c  eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>id\<^sub>c \<nat>\<^sub>c \<circ>\<^sub>c successor,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>\<rangle> \<circ>\<^sub>c  q"
                         using comp_associative2 by (typecheck_cfuncs, force)
                       also have "... = IMPLIES \<circ>\<^sub>c \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c(i \<times>\<^sub>f i) \<circ>\<^sub>c \<langle>successor,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> \<circ>\<^sub>c  q,
                                               NOT \<circ>\<^sub>c  eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>id\<^sub>c \<nat>\<^sub>c \<circ>\<^sub>c successor,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>  \<circ>\<^sub>c  q \<rangle>"
                         by (typecheck_cfuncs, smt (z3) cfunc_prod_comp comp_associative2)
                       also have "... = IMPLIES \<circ>\<^sub>c \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c(i \<times>\<^sub>f i) \<circ>\<^sub>c \<langle>successor \<circ>\<^sub>c  q,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub> \<circ>\<^sub>c  q\<rangle> ,
                                               NOT \<circ>\<^sub>c  eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>id\<^sub>c \<nat>\<^sub>c \<circ>\<^sub>c successor \<circ>\<^sub>c  q,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub> \<circ>\<^sub>c  q\<rangle>\<rangle>"
                         using cfunc_prod_comp comp_associative2 by (typecheck_cfuncs, force)
                      also have "... = IMPLIES \<circ>\<^sub>c \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c(i \<times>\<^sub>f i) \<circ>\<^sub>c \<langle>successor \<circ>\<^sub>c  q, successor \<circ>\<^sub>c n\<rangle> ,
                                               NOT \<circ>\<^sub>c  eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>successor \<circ>\<^sub>c  q, successor \<circ>\<^sub>c n\<rangle>\<rangle>"
                        by (typecheck_cfuncs, metis id_left_unit2 id_right_unit2 id_type one_unique_element)
                      also have "... = IMPLIES \<circ>\<^sub>c \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c  \<langle>i \<circ>\<^sub>c successor \<circ>\<^sub>c  q, i \<circ>\<^sub>c successor \<circ>\<^sub>c n\<rangle> ,
                                               NOT \<circ>\<^sub>c  eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>successor \<circ>\<^sub>c  q, successor \<circ>\<^sub>c n\<rangle>\<rangle>"
                        using cfunc_cross_prod_comp_cfunc_prod by (typecheck_cfuncs, auto)
                      also have "... = \<t>"
                        by (typecheck_cfuncs, metis IMPLIES_false_is_true_false NOT_is_true_implies_false eq_pred_iff_eq true_false_only_truth_values)
                      also have "... = (\<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>) \<circ>\<^sub>c q"
                        by (typecheck_cfuncs, smt (z3) beta_N_succ_mEqs_Id1 comp_associative2 id_right_unit2 successor_type terminal_func_comp)
                      then show "(IMPLIES \<circ>\<^sub>c \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c(i \<times>\<^sub>f i) \<circ>\<^sub>c \<langle>successor,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>,
                     NOT \<circ>\<^sub>c  eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>id\<^sub>c \<nat>\<^sub>c \<circ>\<^sub>c successor,(successor \<circ>\<^sub>c n) \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>\<rangle>) \<circ>\<^sub>c  q = (\<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>) \<circ>\<^sub>c q"
                        using calculation by presburger
                    qed
                  qed
                  show "(IMPLIES \<circ>\<^sub>c
     \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
     \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>) \<circ>\<^sub>c
    successor =
    id\<^sub>c \<Omega> \<circ>\<^sub>c
    IMPLIES \<circ>\<^sub>c
    ...
    \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> : \<nat>\<^sub>c \<rightarrow> \<Omega>"
         ...
         (id\<^sub>c \<Omega> \<circ>\<^sub>c
          ...
          \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>) \<circ>\<^sub>c q"
           ...
           \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
           \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>) \<circ>\<^sub>c
          successor) \<circ>\<^sub>c q = IMPLIES \<circ>\<^sub>c
           \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
           \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> \<circ>\<^sub>c (successor \<circ>\<^sub>c q)"
                        by (typecheck_cfuncs, smt (z3) comp_associative2)
                      also have "... = IMPLIES \<circ>\<^sub>c
           ...
           \<langle>successor \<circ>\<^sub>c q, id one\<rangle>"
                        using cart_prod_extract_left id_left_unit2 by (typecheck_cfuncs, force)
                      also have "... = IMPLIES \<circ>\<^sub>c
           \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c \<langle>successor \<circ>\<^sub>c q, id one\<rangle> ,
            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c \<langle>successor \<circ>\<^sub>c q, id one\<rangle> \<rangle>"
                        using cfunc_prod_comp comp_associative2 by (typecheck_cfuncs, force)
                      also have "... = IMPLIES \<circ>\<^sub>c
           \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c  \<langle>successor \<circ>\<^sub>c q, successor \<circ>\<^sub>c n\<rangle> ,
            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>successor \<circ>\<^sub>c q, successor \<circ>\<^sub>c n\<rangle> \<rangle>"
                        using cfunc_cross_prod_comp_cfunc_prod id_left_unit2 id_right_unit2 by (typecheck_cfuncs, force)
                      also have "... = IMPLIES \<circ>\<^sub>c
           \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c  \<langle>i \<circ>\<^sub>c successor \<circ>\<^sub>c q, i \<circ>\<^sub>c successor \<circ>\<^sub>c n\<rangle> ,
            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>successor \<circ>\<^sub>c q, successor \<circ>\<^sub>c n\<rangle> \<rangle>"
                        by (typecheck_cfuncs, simp add: cfunc_cross_prod_comp_cfunc_prod)
                      also have "... = \<t>"
                        by (typecheck_cfuncs, metis IMPLIES_false_is_true_false NOT_true_is_false eq_pred_iff_eq true_false_only_truth_values)
                     also have "... = IMPLIES \<circ>\<^sub>c
                              \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c  \<langle>i \<circ>\<^sub>c q,i \<circ>\<^sub>c successor \<circ>\<^sub>c n \<rangle>,
                               NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>q, successor \<circ>\<^sub>c n \<rangle>\<rangle>"
                       by (typecheck_cfuncs, metis IMPLIES_false_is_true_false NOT_is_false_implies_true eq_pred_iff_eq true_false_only_truth_values)
                    also have "... = IMPLIES \<circ>\<^sub>c
                              \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c \<langle>q,successor \<circ>\<^sub>c n \<rangle>,
                               NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>q, successor \<circ>\<^sub>c n \<rangle>\<rangle>"
                      using cfunc_cross_prod_comp_cfunc_prod by (typecheck_cfuncs, force)
                    also have "... = IMPLIES \<circ>\<^sub>c
                      ...
                      using cfunc_cross_prod_comp_cfunc_prod id_left_unit2 id_right_unit2 by (typecheck_cfuncs, force)
                    also have "... = IMPLIES \<circ>\<^sub>c
                              \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)),NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n))\<rangle> \<circ>\<^sub>c \<langle>q,id one \<rangle>"
                      using cfunc_prod_comp comp_associative2 by (typecheck_cfuncs, force)
                    also have "... = IMPLIES \<circ>\<^sub>c
                              \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
                              \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> \<circ>\<^sub>c q"
              ...
              show "(\<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>) \<circ>\<^sub>c successor = id\<^sub>c \<Omega> \<circ>\<^sub>c \<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>"
                by (typecheck_cfuncs, smt (verit, best) comp_associative2 id_left_unit2 terminal_func_comp)
            qed
            show "IMPLIES \<circ>\<^sub>c \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> =
    \<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c \<times>\<^sub>c one\<^esub>"
            proof(rule one_separator[where X = "\<nat>\<^sub>c \<times>\<^sub>c one", where Y = "\<Omega>"])
              show "IMPLIES \<circ>\<^sub>c \<langle>NOT \<circ>\<^sub>c
     eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> : \<nat>\<^sub>c \<times>\<^sub>c one \<rightarrow> \<Omega>"
                by typecheck_cfuncs
              show "\<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c \<times>\<^sub>c one\<^esub> : \<nat>\<^sub>c \<times>\<^sub>c one \<rightarrow> \<Omega>"
                by typecheck_cfuncs
              show "\<And>qone. qone \<in>\<^sub>c \<nat>\<^sub>c \<times>\<^sub>c one \<Longrightarrow>
         (IMPLIES \<circ>\<^sub>c
          \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle>) \<circ>\<^sub>c
        qone =
         (\<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c \<times>\<^sub>c one\<^esub>) \<circ>\<^sub>c qone"
              proof - 
                fix qone
                assume qone_type[type_rule]: "qone \<in>\<^sub>c \<nat>\<^sub>c \<times>\<^sub>c one"
                then obtain q where q_type[type_rule]: "q \<in>\<^sub>c \<nat>\<^sub>c" and q_def: "qone = \<langle>q, id one\<rangle>"
                  by (typecheck_cfuncs, metis cart_prod_decomp one_unique_element)

                have "(IMPLIES \<circ>\<^sub>c
          \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle>) \<circ>\<^sub>c qone = 
                      IMPLIES \<circ>\<^sub>c
          \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle>  \<circ>\<^sub>c  \<langle>q, id one\<rangle>"
                  using comp_associative2 q_def by (typecheck_cfuncs, force)
                also have "... = IMPLIES \<circ>\<^sub>c
          \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c  \<langle>q, id one\<rangle>,
          NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c  \<langle>q, id one\<rangle>\<rangle>"
                  using cfunc_prod_comp comp_associative2 by (typecheck_cfuncs, force)
          ...
          NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c    \<langle>q, successor \<circ>\<^sub>c n\<rangle>\<rangle>"
            ...
            then show "(IMPLIES \<circ>\<^sub>c \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle>) \<circ>\<^sub>c qone = (\<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c \<times>\<^sub>c one\<^esub>) \<circ>\<^sub>c qone"
              using  calculation by (typecheck_cfuncs, presburger)
          qed
        qed
      qed
      show "IMPLIES \<circ>\<^sub>c \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> =
            IMPLIES \<circ>\<^sub>c \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n\<rangle>"
      proof - 
        have "IMPLIES \<circ>\<^sub>c \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> =
             \<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<times>\<^sub>c one\<^esub>"
            proof -
              have "IMPLIES \<circ>\<^sub>c \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,
                                NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle>
                                \<circ>\<^sub>c \<langle>id \<nat>\<^sub>c, \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> = \<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>"
              proof (rule natural_number_object_func_unique[where X=\<Omega>, where f="id \<Omega>"])
                show "IMPLIES \<circ>\<^sub>c \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
                        \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> : \<nat>\<^sub>c \<rightarrow> \<Omega>"
                  by typecheck_cfuncs
                show "\<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub> : \<nat>\<^sub>c \<rightarrow> \<Omega>"
                  by typecheck_cfuncs
                ...
                show "(IMPLIES \<circ>\<^sub>c
                     \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,
                      NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
                      \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>) \<circ>\<^sub>c zero = (\<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c\<^esub>) \<circ>\<^sub>c zero"
                proof - 
                  have "(IMPLIES \<circ>\<^sub>c
                     \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,
                      NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c
                  ...
                  also have "... = IMPLIES \<circ>\<^sub>c
                     \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c   \<langle>zero, successor \<circ>\<^sub>c n\<rangle> ,
                      NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c   \<langle>zero, successor \<circ>\<^sub>c n\<rangle>  \<rangle>"
                    by (typecheck_cfuncs, metis (full_types) IMPLIES_false_is_true_false NOT_is_false_implies_true eq_pred_iff_eq true_false_only_truth_values zero_is_not_successor)
                  also have "... = IMPLIES \<circ>\<^sub>c
                     \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c  \<langle>i \<circ>\<^sub>c zero, i \<circ>\<^sub>c successor \<circ>\<^sub>c n\<rangle> ,
                      NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c   \<langle>zero, successor \<circ>\<^sub>c n\<rangle>  \<rangle>"
                    by (typecheck_cfuncs, simp add: cfunc_cross_prod_comp_cfunc_prod)
    ...
    \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>"
                proof(rule one_separator[where X ="\<nat>\<^sub>c", where Y = \<Omega>])
                  show "(IMPLIES \<circ>\<^sub>c \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>) \<circ>\<^sub>c
                            successor : \<nat>\<^sub>c \<rightarrow> \<Omega>"
                    by typecheck_cfuncs
        ...
        ((IMPLIES \<circ>\<^sub>c
         ...
         q"
                  proof - 
                    ...
                    have "((IMPLIES \<circ>\<^sub>c
                          \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,
                            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle>) \<circ>\<^sub>c successor) \<circ>\<^sub>c q  = 
                          IMPLIES \<circ>\<^sub>c
                          \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,
                            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c \<langle>id\<^sub>c \<nat>\<^sub>c,\<beta>\<^bsub>\<nat>\<^sub>c\<^esub>\<rangle> \<circ>\<^sub>c (successor \<circ>\<^sub>c q)"
                      by (typecheck_cfuncs, smt (z3) comp_associative2)
                    also have  "... = IMPLIES \<circ>\<^sub>c
                          \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,
                            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> \<circ>\<^sub>c \<langle>(successor \<circ>\<^sub>c q) ,id one\<rangle>"
                      by (typecheck_cfuncs, metis cart_prod_extract_left cfunc_type_def id_left_unit)
                    also have "... = IMPLIES \<circ>\<^sub>c
                          \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c \<langle>(successor \<circ>\<^sub>c q) ,id one\<rangle>,
                            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c \<langle>(successor \<circ>\<^sub>c q) ,id one\<rangle> \<rangle>"
                      by (typecheck_cfuncs, simp add: cfunc_prod_comp comp_associative2)
          ...
          \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c  \<langle>q,successor \<circ>\<^sub>c n\<rangle>,
            NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c \<langle>q,successor \<circ>\<^sub>c n\<rangle> \<rangle>"
                      by (typecheck_cfuncs, smt (z3) IMPLIES_false_false_is_true IMPLIES_false_true_is_true IMPLIES_true_true_is_true NOT_is_false_implies_true cfunc_cross_prod_comp_cfunc_prod cfunc_type_def comp_associative eq_pred_iff_eq true_false_only_truth_values)
                    also have "... = IMPLIES \<circ>\<^sub>c
                              \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c \<langle>q,id one\<rangle>,
                                NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c (id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f (successor \<circ>\<^sub>c n)) \<circ>\<^sub>c \<langle>q,id one\<rangle>\<rangle>"
                      using cfunc_cross_prod_comp_cfunc_prod id_left_unit2 id_right_unit2 by (typecheck_cfuncs, force)
              ...
              show "IMPLIES \<circ>\<^sub>c \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> =
    \<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c \<times>\<^sub>c one\<^esub>"
                using \<open>IMPLIES \<circ>\<^sub>c \<langle>NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c (i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> = \<t> \<circ>\<^sub>c \<beta>\<^bsub>\<nat>\<^sub>c \<times>\<^sub>c one\<^esub>\<close> calculation by presburger
            qed
            show "IMPLIES \<circ>\<^sub>c \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f successor \<circ>\<^sub>c n\<rangle> =
    IMPLIES \<circ>\<^sub>c \<langle>(NOT \<circ>\<^sub>c eq_pred X \<circ>\<^sub>c i \<times>\<^sub>f i) \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n,NOT \<circ>\<^sub>c eq_pred \<nat>\<^sub>c \<circ>\<^sub>c id\<^sub>c \<nat>\<^sub>c \<times>\<^sub>f n\<rangle>
"
(* This seems to be on line 932 as well.... Are we going in circles?*)
              oops             
